  ...
  "inline-flex items-center rounded-lg border px-2.5 py-0.5 text-[10px] font-bold uppercase tracking-wider transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
        ...
        success:
          "border-transparent bg-emerald-500/10 text-emerald-600 border-emerald-200 hover:bg-emerald-500/20",
        warning:
          "border-transparent bg-amber-500/10 text-amber-600 border-amber-200 hover:bg-amber-500/20",
      },
    },
    defaultVariants: {
      variant: "default",
